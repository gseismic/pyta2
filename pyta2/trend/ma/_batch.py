...
from ._rolling import rSMA, rEMA, rWMA, rHMA, rDEMA, rTEMA, rKAMA, rZLEMA
...
def KAMA(values, n, n1=10, n2=2, n3=30, stride=1, **kwargs):
    return forward_rolling_apply(len(values), rKAMA, param_args=[n, n1, n2, n3, stride], input_args=[np.array(values)], **kwargs)

def ZLEMA(values, n, **kwargs):
    return forward_rolling_apply(len(values), rZLEMA, param_args=[n], input_args=[np.array(values)], **kwargs)

__all__ = ['SMA', 'EMA', 'WMA', 'HMA', 'DEMA', 'TEMA', 'KAMA', 'ZLEMA']
